...
export function MapView({ locations, center, showMarkers = true, showNumbers = false }: MapViewProps) {
    const map = useMap();
        ...
        <div className="w-full h-full min-h-[400px] rounded-lg overflow-hidden">
            ...
            >
                {showMarkers && locations.map((loc, index) => {
                    ...
                    // Use number as glyph if showNumbers is true
                    const glyph = showNumbers ? String(index + 1) : undefined;
