import { solveTSP, solveHierarchicalTSP, Location } from '../lib/tsp-solver';
...
const path = solveTSP(locations, matrix);
...
const hPath = solveHierarchicalTSP(hierarchicalLocations);
